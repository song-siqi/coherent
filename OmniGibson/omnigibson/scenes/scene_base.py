...
class Scene(Serializable, Registerable, Recreatable, ABC):
    ...
    def agent_registry(self):
        ...
        Returns:
            SerializableRegistry: Object registry containing all active standalone objects in the scene
        """
        return self._registry(key="name", value="agent_registry")
    ...
    def agents(self):
        ...
        Returns:
            list of BaseSystem: System(s) that are available to use in this scene
        """
        return self.agent_registry.objects
    ...
    def _create_registry(self):
        ...
        # Add registry for agents
        registry.add(obj=SerializableRegistry(
            name="agent_registry",
            class_types=Robot,
            default_key="name",
            unique_keys=["name", "prim_path"]
        ))
        return registry
    ...
    def add_agent(self, agent, register=True, _is_call_from_simulator=False):
        """
        Add an object to the scene, loading it if the scene is already loaded.
    ...
    def reset(self):
        ...
        # self.load_agent_state(self._initial_agent_state)
        og.sim.step()
